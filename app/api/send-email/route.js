...
export async function POST(request) {
  try {
    ...
    const transporter = nodemailer.createTransport({
      ...
      auth: {
        user: "info@hqws.com.au", // Your Google Workspace email address
    ...
    // Email options
    const mailOptions = {
      from: "info@hqws.com.au", // Your email address
      replyTo: email, // Set the reply-to to the user's email address
      to: "info@hqws.com.au", // Your receiving email address
      subject: `New Quote Request from ${fullName}`,
      html: `
        <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #036057; background-color: #f9fafb; padding: 20px; border-radius: 10px; border: 1px solid #e0e6ed;">
          <h2 style="color: #CAA24E; text-align: center; margin-bottom: 20px;">New Quote Request</h2>
          ...
          <table style="width: 100%; border-collapse: collapse; margin-top: 20px; background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.1);">
            <tr style="background-color: #036057; color: #ffffff;">
          ...
          <p style="text-align: center; color: #CAA24E; font-weight: bold; margin-top: 20px;">Best Regards,</p>
          <p style="text-align: center; color: #CAA24E;">High Quality Walling Services Company</p>
        </div>
      `,
    };
