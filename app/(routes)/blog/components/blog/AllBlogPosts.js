...
export default function AllBlogPosts({
  ...
  return (
    <>
      ...
      <PageHeader
        title="Walling & Rendering Insights"
        description="Explore expert tips, guides, and industry insights on walling, rendering, and finishing solutions in Adelaide. Stay informed with our latest blogs."
